/*
	...
	CodeBook4MMX.h - 4 u8 MMX optimized Codebook class
...
public:
	...
	long __attribute__((__fastcall__))  DiffMag(cbVector &Vect);	// Magnitude of the difference between this and Vect (Dist ^ 2)
