...
#ifndef BROKENINSTR // TODO: this library crashes in the instrinsics code on WIN32 at least when cross compiled using GCC from a mac. we really want to fix the crash and not disable instrinsics
#define DXT_INTR 1
#endif
